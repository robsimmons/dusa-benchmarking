...
- `node bench-mapgeneration.js > results/mapgeneration-tests.csv` - Scaled version of Adam Smith's Map Generation Speedrun, https://eis-blog.soe.ucsc.edu/2011/10/map-generation-speedrun/
